...
<body>
  ...
  <div class="container">
  <h1 style="margin-top: 20px; color:  #fff; margin-bottom: 30px;">7-Day Weight Gain Nutrition Plan</h1>
  ...
  <div class="day">
    ...
    <ul>
      ...
      <li>Protein: 30g, Carbs: 50g, Fat: 10g, Calories: 500
  ...
  <div class="day">
    ...
    <p>Dinner:</p>
    <ul>
      <li>Roast chicken with quinoa and roasted vegetables</li>
      <li>Protein: 35g, Carbs: 40g, Fat: 15g, Calories: 550 kcal</li>
    </ul>
    <p>Total Protein: 105g, Total Carbs: 170g, Total Fat: 55g, Total Calories: 1850 kcal</p>
  </div>
</div>
